...
namespace Stardew_Valley___A_Murder_Mystery
{
    class ExploreNorth : Location
    {
        ...
        public override void Enter()
        {
            ...
            Console.WriteLine("On a small cliff behind the house is a tent and a small campfire. A set of steps leads further up the cliff.");
            ...
            Console.WriteLine("[Robins] house added to location list");
            Console.WriteLine("[Mine] added to location list");
            Console.WriteLine("Adventurer's [Guild] added to location list");
            Console.WriteLine("[North] of town added to location list");
        }
